...
<p><a href="https://github.com/ArchiveBox/android-archivebox/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/ArchiveBox/android-archivebox/ci.yml?branch=main&amp;label=Build%20%26%20release" alt="Live main-branch build and release status"></a> <a href="https://github.com/ArchiveBox/android-archivebox/releases"><img src="https://img.shields.io/github/v/release/ArchiveBox/android-archivebox?label=Latest%20release&amp;color=9b2854" alt="Latest published GitHub release"></a></p>

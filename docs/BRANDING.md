...
The website and README use the existing ArchiveBox organization logo unchanged, copied from the sibling `electron-archivebox/docs/assets` directory. Its upstream source is the [ArchiveBox organization avatar](https://avatars.githubusercontent.com/u/74894248?v=4). The favicon, Apple touch icon, and generic ArchiveBox social card come from the same repository.

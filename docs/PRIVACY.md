...
- Discovery checks network candidates on port 5759. A discovery check does not authenticate with your saved API key. Tailnet names you enter are resolved through the device’s configured network and DNS.

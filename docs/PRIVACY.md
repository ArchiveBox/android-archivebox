...
- Discovery checks network candidates on port 5797. A discovery check does not authenticate with your saved API key. Tailnet names you enter or import from Tailscale status JSON are resolved through the device’s configured network and DNS.

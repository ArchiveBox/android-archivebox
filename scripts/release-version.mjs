...
if (process.env.GITHUB_EVENT_NAME === 'workflow_dispatch') {
  ...
  if (changes.some(file => !isCaptureOnlyFile(file))) throw new Error('Unreleased Android app changes require the normal push release before server compatibility capture');
